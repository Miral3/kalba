...
public class MemberDataThread extends Thread {
    ...
    public MemberDataThread(StatisticMongoRepository statisticMongoRepository) {
        this.statisticMongoRepository = statisticMongoRepository;
    }

    private final static Set<String> clanCodeSet = ConcurrentHashMap.newKeySet();
...
//        Collections.sort(statisticList);
    ...
    private static double calListScore(List<LinkedHashMap<Object, Object>> list, String userTag) {
        double score = 0;
        ...
        private double calYonghaScore(String userTag) {
            ...
            try {
                ...
                if (body.get("troops") != null) {
                    ...
                    score += calListScore((List<LinkedHashMap<Object, Object>>) troopsObject, userTag);
                }
                if (body.get("heroes") != null) {
                    Object heroesObject = body.get("heroes");
                    statistic.setHeroes(heroesObject);
                    score += calListScore((List<LinkedHashMap<Object, Object>>) heroesObject, userTag);
                }
                if (body.get("spells") != null) {
                    Object spellsObject = body.get("spells");
                    statistic.setSpells(spellsObject);
                    score += calListScore((List<LinkedHashMap<Object, Object>>) spellsObject, userTag);
                }
